...
public class Validator {
	...
	private static final String EMAIL_VALID = "^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@(fsoft.com.vn)$";// +: 1 hoac
																										// nhieu
	...
	public static Date checkInvalidDate(String date) {
		...
		if (((year % 4 == 0) && (year % 100 != 0)) || (year % 400 == 0)) {
			if (month == 2 && day > 29) {
				throw new BirthDateException("You enter wrong " + month + " can not have " + day + " day beacause "
						+ year + " is a leap year" + ". Default birth date will be apply");
			}
		}
